...
<head>
    ...
    <script>
        ...
        function validateform() {
            if (document.userfilter.name.value == "" && document.userfilter.admin.value == "" && document.userfilter.manager.value == "") {
...
<center>
    <table border="1" width="800" height="30" cellspacing="0" cellpadding="0" bgcolor="#E4E4E4"
        ...
        <center>
            <table border="1" width="800" cellspacing="0" cellpadding="0" bgcolor="#E4E4E4" bordercolorlight="#C2C2C2"
                ...
                <tr>
                    <td>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <img src="pics/user.png" alt="用户管理" width="50" height="50" align="absmiddle">
                        <strong><font color="#66CCFF" size="5">用户管理</font></strong></td>
                </tr>
                <tr>
                    <form action="userfilter.php" method="post" name="userfilter"
                          onSubmit="return validateform( this.form )">
                        <table border="1" width="800" cellspacing="0" cellpadding="0" bgcolor="#E4E4E4"
                               bordercolorlight="#C2C2C2" bordercolordark="#FFFFFF">
                            <tr height="30">
                                <td>姓名:<input type="text" name="name" size="20"></td>
                                <td>管理员:<input type="text" name="admin" size="30"></td>
                                <td>经理:<input type="text" name="manager" size="30"></td>
...
<div align="center">
    <table border="1" width="800" cellspacing="0" cellpadding="0" bgcolor="#E4E4E4" bordercolorlight="#C2C2C2"
        ...
        for ($i = 0; $i < $rows; $i++) {
            ...
            <tr>
                ...
                <td width="20%">
                    <div align="center"><?php echo "$mailbox" ?></div>
                </td>
                <td width="15%">
                    <div align="center"><?php echo "$phonenum" ?></div>
                </td>
                <td width="20%">
                    <div align="center"><?php echo "$manager" ?></div>
                </td>
                <td width="15%">
                    <div align="center"><?php echo "$usertype" ?></div>
                </td>

                <td width="5%">
                    <div align="center">
                        <a href="userinfo.php?userid=<?php echo "$userid" ?>">
                            <img src="pics/view.png" alt="显示详细信息" border="0" width="30" height="30"></a></div>
                </td>
                <td width="5%">
                    <div align="center">
    ...
    <table border="1" width="800" cellspacing="0" cellpadding="0" bgcolor="#E4E4E4" bordercolorlight="#C2C2C2"
        ...
        <tr>
            <td align="center">
                <?php
                echo "<a href='usermanage.php?page_no=1'>首页</a>";
                echo "&nbsp;";
                echo "<a href='usermanage.php?page_no=".($page_no - 1)."'>上一页</a>";
                echo "&nbsp;";
                echo "第".$page_no."页 [共".$page_total."页]";
                echo "&nbsp;";
                echo "<a href='usermanage.php?page_no=".($page_no + 1)."'>下一页</a>";
                echo "&nbsp;";
                echo "<a href='usermanage.php?page_no=".$page_total."'>尾页</a>";
                ?>
            </td>
        </tr>
    </table>
...
<center>
    ...
    <table border="1" width="800" height="50" cellspacing="0" cellpadding="0" bgcolor="#E4E4E4"
           bordercolorlight="#C2C2C2" bordercolordark="#FFFFFF">
        <tr>
