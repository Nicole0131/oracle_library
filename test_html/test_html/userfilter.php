...
<table border="1" width="800" height="30" cellspacing="0" cellpadding="0" bgcolor="#E4E4E4" bordercolorlight="#C2C2C2" bordercolordark="#FFFFFF">
    ...
    <td><img src="pics/rightdir.png" width="16" height="16" align="absmiddle">[&gt;<a href="usermanage.php">用户管理</a>&lt;]</td>
	</tr>
</table>
</center>
<!--************************************************************-->
...
<table border="1" width="800" cellspacing="0" cellpadding="0" bgcolor="#E4E4E4" bordercolorlight="#C2C2C2" bordercolordark="#FFFFFF">
	...
	<td width="15%"><div align="center">经理</div></td>
	<td width="15%"><div align="center">用户类型</div></td>
	...
	<img src="pics/view.png" alt="显示详细信息" border="0" width="30" height="30"></a></div></td>
	<td width="5%"><div align="center">
	<a href="userdelete.php?userid=<?php echo "$userid"?>">
	<img src="pics/delete.png" alt="删除" border="0" width="30" height="30"></a></div></td>
	</tr>
	<?php
		}
