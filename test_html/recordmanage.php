...
<div align="center">
    <center>
        ...
        $query = "select * from books join record on books.ID = record.book_ID join user on user.user_ID = record.user_ID where books.Status = 'borrowed' order by books.ID asc ";
...
<div align="center">
    <table border="1" width="900" cellspacing="0" cellpadding="0" bgcolor="#E4E4E4" bordercolorlight="#C2C2C2"
        ...
        for ($i = 0; $i < $rows; $i++) {
            ...
            $bname = $data['BookName'];
            $layout = $data['Layout'];//added by Daijie on 2014/2/11
            $returnday =  $data['ReturnDay'];//$data['borrowedDate'];
    ...
    <table border="1" width="900" cellspacing="0" cellpadding="0" bgcolor="#E4E4E4" bordercolorlight="#C2C2C2"
        ...
        <tr>
            <td align="center">
                <?php
                echo "<a href='recordmanage.php?page_no=1'>首页</a>";
                echo "&nbsp;";
                echo "<a href='recordmanage.php?page_no=" . ($page_no - 1) . "'>上一页</a>";
                echo "&nbsp;";
                echo "第" . $page_no . "页 [共" . $page_total . "页]";
                echo "&nbsp;";
                echo "<a href='recordmanage.php?page_no=" . ($page_no + 1) . "'>下一页</a>";
                echo "&nbsp;";
                echo "<a href='recordmanage.php?page_no=" . $page_total . "'>尾页</a>";
                ?>
            </td>
        </tr>
    </table>
